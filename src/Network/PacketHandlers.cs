	...
	public class PacketHandlers
	{
		...
		private static void AddAuthID(int authID)
		{
			...
			if ( !wasSet )
			{
				...
				m_AuthIDWindowAge[oldestIndex] = Core.Now;
			}
		}
		...
		public static void LoginServerSeed( NetState state, PacketReader pvSrc )
		{
			...
			state.Version = new ClientVersion( clientMaj, clientMin, clientRev, clientPat, ClientType.Regular );
		}
