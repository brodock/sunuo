...
namespace Server.Mobiles
{
	public class SBProvisioner : SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			...
			{
				Add( new GenericBuyInfo( "1041055", typeof( GuildDeed ), 12450, 20, 0x14F0, 0 ) ); // NEEDS TO BE REMOVED WHEN NEW GUILD SYSTEM IS IN
				...
				Add( new GenericBuyInfo( typeof( SkullCap ), 7, 20, 0x1544, 0x31E ) );
				Add( new GenericBuyInfo( typeof( Bandana ), 6, 20, 0x153F, 0x215 ) );
				Add( new GenericBuyInfo( typeof( TricorneHat ), 8, 20, 0x171B, 0x282 ) );
				Add( new GenericBuyInfo( typeof( FeatheredHat ), 10, 20, 0x171A, 0x217 ) );
				Add( new GenericBuyInfo( typeof( LeatherCap ), 10, 20, 0x1DB9, 0x252 ) );
				Add( new GenericBuyInfo( typeof( WizardsHat ), 11, 20, 0x1718, 0x34C ) );			
				Add( new GenericBuyInfo( typeof( StrawHat ), 7, 20, 0x1717, 0x2B5 ) );
				Add( new GenericBuyInfo( typeof( TallStrawHat ), 8, 20, 0x1716, 0x282 ) );
				Add( new GenericBuyInfo( typeof( Cap ), 10, 20, 0x1715, 0x2D4 ) );
				Add( new GenericBuyInfo( typeof( WideBrimHat ), 8, 20, 0x1714, 0 ) );
				Add( new GenericBuyInfo( typeof( FloppyHat ), 7, 20, 0x1713, 0x282 ) );
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				Add( typeof( Dices ), 1 );
				Add( typeof( GuildDeed ), 6225 ); // NEEDS TO BE REMOVED WHEN NEW GUILD SYSTEM IS IN PLACE
