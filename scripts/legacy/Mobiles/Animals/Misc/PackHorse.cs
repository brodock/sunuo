...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public PackHorse() : base( AIType.AI_Animal, FightMode.Agressor, 10, 1, 0.2, 0.4 )
		{
			Name = "a pack horse";
			Body = 291;
			BaseSoundID = 0xA8;
	...
	public class PackAnimal
	{
		...
		public static bool CheckAccess( BaseCreature animal, Mobile from )
		{
			...
			if ( from.Alive && animal.Controled && !animal.IsDeadPet && (from == animal.ControlMaster || from == animal.SummonMaster) )
				return true;
