...
namespace Server.Factions
{
	public class ElectionGump : FactionGump
	{
		...
		public ElectionGump( PlayerMobile from, Election election ) : base( 50, 50 )
		{
			...
			// TODO: Nominees?!? 1011442..

			switch ( election.State )
			{
				case ElectionState.Pending:
				{
					TimeSpan toGo = ( election.LastStateTime + Election.PendingPeriod ) - Core.Now;
				...
				{
					TimeSpan toGo = ( election.LastStateTime + Election.CampaignPeriod ) - Core.Now;
					int days = (int) (toGo.TotalDays + 0.5);
				...
				{
					TimeSpan toGo = ( election.LastStateTime + Election.VotingPeriod ) - Core.Now;
