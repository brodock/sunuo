...
{
	public class SpeechLog : ICollection
	{
		...
		{
			Commands.Register( "SpeechLog", AccessLevel.GameMaster, new CommandEventHandler( SpeechLog_OnCommand ) );
		}
		...
		public bool IsSynchronized{ get{ return m_Queue.IsSynchronized; } }
		public object SyncRoot{ get{ return m_Queue.SyncRoot; } }
