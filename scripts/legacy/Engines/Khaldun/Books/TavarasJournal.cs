...
namespace Server.Items
{
	...
	{
		[Constructable]
		public TavarasJournal1() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 6, false )
		{
	...
	{
		[Constructable]
		public TavarasJournal2() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 9, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Two:",
	...
	{
		[Constructable]
		public TavarasJournal3() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 6, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Three - Day Five:",
	...
	{
		[Constructable]
		public TavarasJournal6() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 7, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Six:",
	...
	{
		[Constructable]
		public TavarasJournal7() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 6, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Seven:",
	...
	{
		[Constructable]
		public TavarasJournal8() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 8, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Eight :",
	...
	{
		[Constructable]
		public TavarasJournal9() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 6, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Nine - Day Ten:",
	...
	{
		[Constructable]
		public TavarasJournal11() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 8, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Eleven - Day",
	...
	{
		[Constructable]
		public TavarasJournal14() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 7, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Fourteen - Day",
	...
	{
		[Constructable]
		public TavarasJournal16() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 8, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Sixteen:",
	...
	{
		[Constructable]
		public TavarasJournal16b() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 7, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Sixteen, Later :",
	...
	{
		[Constructable]
		public TavarasJournal17() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 4, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Seventeen - Day",
	...
	{
		[Constructable]
		public TavarasJournal19() : base( Utility.Random( 0xFF1, 2 ), "Journal: Discovery of the Tomb", "Tavara Sewel", 3, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Nineteen - Day",
