...
namespace Server.Items
{
	...
	{
		[Constructable]
		public GrimmochJournal1() : base( Utility.Random( 0xFF1, 2 ), "The daily journal of Grimmoch Drummel", "Grimmoch", 5, false )
		{
	...
	{
		[Constructable]
		public GrimmochJournal2() : base( Utility.Random( 0xFF1, 2 ), "The daily journal of Grimmoch Drummel", "Grimmoch", 7, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Two :",
	...
	{
		[Constructable]
		public GrimmochJournal3() : base( Utility.Random( 0xFF1, 2 ), "The daily journal of Grimmoch Drummel", "Grimmoch", 7, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Three - Day Five:",
	...
	{
		[Constructable]
		public GrimmochJournal6() : base( Utility.Random( 0xFF1, 2 ), "The daily journal of Grimmoch Drummel", "Grimmoch", 6, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Six :",
	...
	{
		[Constructable]
		public GrimmochJournal7() : base( Utility.Random( 0xFF1, 2 ), "The daily journal of Grimmoch Drummel", "Grimmoch", 5, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Seven - Day Ten:",
	...
	{
		[Constructable]
		public GrimmochJournal11() : base( Utility.Random( 0xFF1, 2 ), "The daily journal of Grimmoch Drummel", "Grimmoch", 4, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Eleven - Day",
	...
	{
		[Constructable]
		public GrimmochJournal14() : base( Utility.Random( 0xFF1, 2 ), "The daily journal of Grimmoch Drummel", "Grimmoch", 5, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Fourteen - Day",
	...
	{
		[Constructable]
		public GrimmochJournal17() : base( Utility.Random( 0xFF1, 2 ), "The daily journal of Grimmoch Drummel", "Grimmoch", 6, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Seventeen - Day",
	...
	{
		[Constructable]
		public GrimmochJournal23() : base( Utility.Random( 0xFF1, 2 ), "The daily journal of Grimmoch Drummel", "Grimmoch", 1, false )
		{
			Pages[0].Lines = new string[]
				{
					"Day Twenty-Three :",
