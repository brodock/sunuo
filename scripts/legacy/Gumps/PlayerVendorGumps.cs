...
namespace Server.Gumps
{
	...
	public class NewPlayerVendorCustomizeGump : Gump
	{
		...
		private class HairOrBeard
		{
			...
			public HairOrBeard( Type type, int name )
			{
				m_Type = type;
				m_Name = name;
			}
		...
		private static HairOrBeard[] m_HairStyles = new HairOrBeard[]
			{
				new HairOrBeard( typeof( ShortHair ),			1011052 ),	// Short
				new HairOrBeard( typeof( LongHair ),			1011053 ),	// Long
				new HairOrBeard( typeof( PonyTail ),			1011054 ),	// Ponytail
				new HairOrBeard( typeof( Mohawk ),				1011055 ),	// Mohawk
				new HairOrBeard( typeof( PageboyHair ),			1011047 ),	// Pageboy
				new HairOrBeard( typeof( KrisnaHair ),			1011050 ),	// Topknot
				new HairOrBeard( typeof( Afro ),				1011396 ),	// Curly
				new HairOrBeard( typeof( ReceedingHair ),		1011048 ),	// Receding
				new HairOrBeard( typeof( TwoPigTails ),			1011049 )	// 2-tails
			};

		private static HairOrBeard[] m_BeardStyles = new HairOrBeard[]
			{
				new HairOrBeard( typeof( Mustache ),			1011062 ),	// Mustache
				new HairOrBeard( typeof( ShortBeard ),			1011060 ),	// Short beard
				new HairOrBeard( typeof( MediumShortBeard ),	1015321 ),	// Short Beard & Moustache
				new HairOrBeard( typeof( LongBeard ),			1011061 ),	// Long beard
				new HairOrBeard( typeof( MediumLongBeard ),		1015322 ),	// Long Beard & Moustache
				new HairOrBeard( typeof( Goatee ),				1015323 ),	// Goatee
				new HairOrBeard( typeof( Vandyke ),				1011401 )	// Vandyke
			};
